...
public class userreviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_userreview, container, false);
        ratingBar = (RatingBar) v.findViewById(R.id.ratingBar);
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            public void onRatingChanged(RatingBar rtBar, float rating,boolean fromUser) {
                float rt = rtBar.getRating();
                retype=String.valueOf(rt);
            }
        });
        Review=(EditText)v.findViewById(R.id.etReview);
        submit=(Button)v.findViewById(R.id.rsubmit);
    ...
    protected void bg5(String type, String retype, String review) {
        BackgroundWorker2 mtask=new BackgroundWorker2(this);
        mtask.execute(type,retype,review);
    }
