...
public class userorderFragment extends Fragment {
    private static final String url="https://nammacanteen.000webhostapp.com/php_codes/canteen_usOrder.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_userorder, container, false);
        recyclerView=(RecyclerView)v.findViewById(R.id.recylcerView_o);
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                orderList.add(new Order(
                                        ...
                                        order.getString("orderon"),
                                        order.getString("phoneno"),
                                        order.getString("OrderAmt")
                                ));
                            }
