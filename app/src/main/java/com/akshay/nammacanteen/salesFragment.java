...
public class salesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=(RecyclerView)v.findViewById(R.id.recylcerView_s);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                JSONObject sales = array.getJSONObject(i);

                                //adding the product to product list
                                salesList.add(new Sales(
                                        sales.getString("itemname"),
                                        sales.getString("salesid"),
                                        sales.getString("soldon"),
                                        sales.getDouble("total"),
                                        sales.getInt("quantity")
                                ));
                            }
